...
use LaTorres\UsuarioBundle\Form\EmpleadoType;
...
class EmpleadoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('UsuarioBundle:Empleado')->findAll();

        return $this->render('UsuarioBundle:Empleado:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('UsuarioBundle:Empleado')->find($id);
        ...
        return $this->render('UsuarioBundle:Empleado:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function newAction()
    {
        ...
        return $this->render('UsuarioBundle:Empleado:new.html.twig', array(
            'entity' => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('UsuarioBundle:Empleado:edit.html.twig', array(
            'entity'      => $entity,
